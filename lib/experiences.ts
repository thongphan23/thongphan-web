...
export const experiences: readonly ExperienceDefinition[] = [
  ...
  {
    id: 'content-workflow-7days',
    version: '1.0.0',
    type: 'challenge',
    status: 'published',
    availability: 'always',
    href: '/challenge/content-workflow-7days',
    title: '7 ngày tự xây Content Workflow đầu tiên',
    promise: 'Biến customer evidence, Content Job và tiêu chuẩn của business thành một workflow AI có thể dùng lại.',
    audience: 'Founder hoặc người ra quyết định đã có business, một offer thật và customer evidence để làm việc.',
    problem: 'Mỗi lần làm content vẫn bắt đầu từ trang trắng và founder phải sửa gần như toàn bộ output AI.',
    durationLabel: '7 ngày tự học',
    output: 'Content Workflow Starter Kit v1.0 gồm brief, prompt, content đã review, One-Pager và kế hoạch 14 ngày.',
    ctaLabel: 'Bắt đầu với một offer',
    access: { kind: 'public', label: 'Miễn phí · Không cần tài khoản' },
    media: {
      src: '/images/challenges/content-workflow-7days-fieldbook.webp',
      alt: 'Chồng hồ sơ Content Workflow buộc bằng sợi chỉ đỏ trên nền than',
      width: 1254,
      height: 1254,
      fit: 'contain',
      position: '50% 50%',
