...
export const CONAN_SCHOOL_CASE = {
  ...
  disclosure: 'Tình huống này dùng định vị và sản phẩm thật của Conan School. Các bước quy trình đang được thiết kế để giảng dạy; đây không phải bằng chứng về một quy trình vận hành hay kết quả kinh doanh đã được kiểm chứng.',
} as const
...
export const CONTENT_WORKFLOW_DAYS: readonly ContentWorkflowDay[] = [
  {
    ...
    title: 'Quy trình không phải là một câu lệnh thật dài',
    question: 'Bạn đang thiết kế con đường lặp lại nào?',
    concept: 'Bản mô tả thiết kế quy trình (Workflow Design Brief)',
    artifact: 'Bản mô tả quy trình',
    ...
    theory: [
      { title: 'Một quy trình là con đường có thể chạy lại', body: 'Quy trình bắt đầu khi một điểm kích hoạt xuất hiện, nhận đầu vào đã biết, đi qua một chuỗi chuyển đổi và kết thúc ở một đầu ra quan sát được. Người khác phải có khả năng nhận ra lúc nào quy trình bắt đầu và lúc nào nó thực sự hoàn tất.' },
      { title: 'Quy trình chứa quyết định và cổng chất lượng', body: 'Một chuỗi thao tác chưa đủ. Bạn cần nhìn thấy chỗ con người phải phán đoán và cổng chất lượng (quality gate) phải vượt qua trước khi đầu ra được chuyển tiếp.' },
      { title: 'Thiết kế trước công cụ', body: 'Quy trình mô tả logic công việc, không phụ thuộc ChatGPT, Claude, Notion hay một ứng dụng cụ thể. Khi logic đúng, bạn mới chọn công cụ phù hợp cho từng bước.' },
    ],
    misconceptions: [
      { myth: 'Câu lệnh chính là quy trình.', correction: 'Câu lệnh chỉ là một hướng dẫn nằm trong một hoặc vài bước của quy trình.' },
      { myth: 'Quy trình phải tự động hóa.', correction: 'Bản đầu có thể hoàn toàn thủ công, miễn là chạy lại được và có tiêu chuẩn.' },
      { myth: 'Càng nhiều bước càng chặt chẽ.', correction: 'Chỉ giữ bước tạo ra một chuyển đổi hoặc quyết định cần thiết.' },
      { myth: 'Quy trình đầu tiên phải làm mọi loại nội dung.', correction: 'Hãy chọn đúng một đầu ra đủ hẹp để thử trong bảy ngày.' },
    ],
    conanCase: caseFor('Thu hẹp “dùng AI làm nội dung” thành một kết quả rõ', 'Conan School chọn tình huống biến một khái niệm trong Hành trình Builder thành một tài sản học tập công khai. Đầu ra phải giúp người đọc hiểu một ý, thực hiện một hành động và tạo một sản phẩm nhỏ—không phải “làm nội dung hay hơn” một cách chung chung.', 'Giữ một loại đầu ra là bài học chữ; chưa làm video, landing page hay chiến dịch bán hàng.'),
    practice: ['Chọn một công việc nội dung bạn đã làm hoặc muốn làm lặp lại.', 'Ghi điểm kích hoạt khiến công việc bắt đầu và các đầu vào bạn đang có.', 'Mô tả đầu ra cuối cùng cùng người sẽ sử dụng nó.', 'Ghi vướng mắc hiện tại, phạm vi bảy ngày và ít nhất hai điều quy trình này không làm.', 'Đọc lại toàn bộ bản mô tả và thu hẹp một chỗ còn mơ hồ.'],
    ...
    aiLab: { duration: '20–30 phút tùy chọn', role: 'AI đóng vai người phỏng vấn và phản biện phạm vi.', prompt: 'Hãy phỏng vấn tôi từng câu để làm rõ quy trình tôi muốn xây. Chỉ hỏi một câu mỗi lượt về điểm kích hoạt, đầu vào, đầu ra, người dùng đầu ra, vướng mắc, phạm vi và điều không làm. Sau khi tôi trả lời đủ, hãy chỉ ra ba chỗ còn mơ hồ và đặt câu hỏi để tôi tự quyết định; không tự thiết kế quy trình cuối cùng thay tôi.' },
    minimum: 'Một bản mô tả có tên quy trình, công việc lặp lại, điểm kích hoạt, đầu vào, đầu ra, người dùng, vướng mắc, phạm vi và điều không làm.',
  ...
  },
  {
    ...
    question: 'AI cần biết điều gì trước mỗi lần quy trình chạy?',
    concept: 'Hồ sơ bối cảnh phiên bản 1 (Context Pack v1)', artifact: 'Hồ sơ bối cảnh',
    problem: 'Nếu mỗi lần chạy bạn lại kể lại doanh nghiệp, chuyên môn, đối tượng và giọng điệu theo một cách khác, đầu ra sẽ thay đổi khó đoán. Nếu bạn đổ toàn bộ tài liệu thô vào AI, thông tin quan trọng lại chìm trong nhiễu. Hồ sơ bối cảnh là lớp thông tin ổn định, đã chọn lọc để quy trình dùng lại.',
    theory: [
    ...
    misconceptions: [
      ...
      { myth: 'AI đã nhớ doanh nghiệp từ các cuộc trò chuyện cũ.', correction: 'Quy trình phải mang theo bối cảnh cần thiết cho mỗi lần chạy.' },
    ...
    practice: ['Ghi doanh nghiệp hoặc dự án, chuyên môn hoặc sản phẩm và người nhận dự kiến.', 'Liệt kê điều bạn đã biết và tách riêng nhận định hiện tại.', 'Ghi giọng điệu, điều phải làm và điều không được làm.', 'Liệt kê tài liệu có thể tham chiếu cùng khoảng trống cần bổ sung.', 'Loại bỏ dữ liệu nhạy cảm hoặc chi tiết không giúp quy trình ra quyết định.'],
    ...
    revision: 'Xóa một đoạn chỉ “có vẻ hữu ích” nhưng không ảnh hưởng tới bất kỳ quyết định nào trong quy trình.',
    aiLab: { duration: '20–30 phút tùy chọn', role: 'AI đóng vai người phỏng vấn bối cảnh và biên tập viên rút gọn.', prompt: 'Hãy phỏng vấn tôi để tạo Hồ sơ bối cảnh cho quy trình đã chọn. Tách rõ: điều đã biết, nhận định hiện tại và khoảng trống cần bổ sung. Khi tóm tắt, không thêm thành tích, khách hàng, doanh thu, bằng chứng hoặc thông tin tôi chưa cung cấp. Cuối cùng hãy chỉ ra phần nào không ảnh hưởng tới quyết định của quy trình để tôi cân nhắc loại bỏ.' },
    minimum: 'Một Hồ sơ bối cảnh có danh tính, chuyên môn hoặc sản phẩm, người nhận, điều đã biết, nhận định, giọng điệu, giới hạn, tài liệu và khoảng trống.',
    insideConan: 'Conan School dành cho người đang xây doanh nghiệp đầu tiên; Conan Maker là một sản phẩm khác dành cho người đã có doanh nghiệp và đang gặp nút thắt vận hành phụ thuộc người sáng lập (founder).',
  },
  {
    ...
    misconceptions: [
      ...
      { myth: 'Có thể vừa viết vừa quyết định đầu ra.', correction: 'Khi đích đổi giữa đường, quy trình không thể ổn định.' },
  ...
  },
  {
    ...
    concept: 'Bản đồ quy trình (Workflow Map)', artifact: 'Bản đồ quy trình',
    ...
    theory: [
      ...
      { title: 'Hiển thị quyết định và cổng chất lượng', body: 'Điểm con người quyết định phải được viết ra. Cổng chất lượng cho biết điều kiện để chuyển sang bước sau và ngăn lỗi lan tới cuối quy trình.' },
    ],
    misconceptions: [
      { myth: 'Mỗi cú nhấp là một bước.', correction: 'Gom thao tác cùng phục vụ một chuyển đổi thành một bước chính.' },
      { myth: 'Quy trình luôn tuyến tính.', correction: 'Có thể quay lại bước trước khi không vượt cổng chất lượng.' },
      { myth: 'Nhiều bước đồng nghĩa kiểm soát tốt.', correction: 'Bước thừa làm tăng bàn giao và cơ hội mất bối cảnh.' },
      { myth: 'Người sáng lập cứ giữ quyết định trong đầu.', correction: 'Quyết định vô hình khiến quy trình không thể bàn giao hoặc cải tiến.' },
    ],
  ...
  },
  {
    ...
    concept: 'Quy trình có thể chạy (Runnable Workflow)', artifact: 'Quy trình có thể chạy',
    problem: 'Giao toàn bộ quy trình cho AI có thể tạo kết quả nhanh nhưng che khuất ai chịu trách nhiệm về mục tiêu, sự thật và quyết định cuối. Ngược lại, bắt con người làm mọi việc khiến AI không tạo được đòn bẩy. Phân vai đúng biến bản đồ hôm qua thành hướng dẫn có thể chạy ngay.',
    theory: [
      ...
      { title: 'Con người giữ phán đoán và sự thật', body: 'Con người chọn mục tiêu, bảo vệ bối cảnh nhạy cảm, xác nhận tuyên bố, xử lý đánh đổi và duyệt cuối. Những điểm này phải xuất hiện trong quy trình.' },
    ...
    misconceptions: [
      ...
      { myth: 'Sửa câu lệnh sẽ cứu mọi quy trình.', correction: 'Lỗi có thể nằm ở bối cảnh, đầu vào, phân vai hoặc hợp đồng đầu ra.' },
    ],
    conanCase: caseFor('Đặt AI ở nơi tạo đòn bẩy cho Builder', 'AI có thể đề xuất góc học tập, cấu trúc và kiểm tra theo tiêu chí. Con người chọn luận điểm, xác nhận sự thật thương hiệu, duyệt lời hứa học tập và quyết định sản phẩm có thật sự giúp người học tiến lên.', 'Mỗi bước có hướng dẫn riêng; quy trình dừng ở quyết định quan trọng thay vì để AI tự chọn và viết tới cuối.'),
    practice: ['Chọn vai trò con người, AI, phối hợp hoặc công cụ cho từng bước.', 'Viết mục đích, hướng dẫn và định dạng đầu ra cho mỗi bước.', 'Thêm quy tắc tự kiểm và dữ liệu bàn giao.', 'Đọc lại mọi điểm con người quyết định.', 'Ghép các thẻ hướng dẫn thành một quy trình có thể sao chép và chạy.'],
    qualityGate: ['Mọi bước đều có người hoặc hệ thống chịu trách nhiệm.', 'Đầu vào và đầu ra cho AI cụ thể.', 'Quyết định cần phán đoán cao thuộc về con người.', 'AI không được tự xác nhận dữ liệu nó có thể đã bịa.', 'Quy trình chạy được trước khi tự động hóa.'],
    revision: 'Tìm một bước đang ghi “phối hợp” nhưng không nói ai quyết định cuối; viết lại trách nhiệm đó.',
    aiLab: { duration: '20–30 phút tùy chọn', role: 'AI đóng vai người kiểm toán phân vai.', prompt: 'Hãy kiểm toán cách tôi phân vai cho từng bước. Tìm chỗ AI được giao quá nhiều quyền, con người đang làm việc lặp lại có thể giao cho AI, hoặc dữ liệu bàn giao bị thiếu. Mô phỏng một tình huống thiếu đầu vào và hỏi quy trình phải dừng ở đâu. Không tự thay đổi vai trò; hãy đưa rủi ro để tôi quyết định.' },
    minimum: 'Mỗi bước có vai trò, mục đích, hướng dẫn, định dạng đầu ra, tự kiểm và bàn giao; sau đó tạo được một bản quy trình có thể chạy.',
  ...
  },
  {
    ...
    title: 'Chạy thử để tìm đúng nơi quy trình bị vỡ',
    question: 'Quy trình hỏng ở đầu vào, bước làm hay tiêu chuẩn?',
    concept: 'Nhật ký chạy thử (Test Run Log)', artifact: 'Nhật ký chạy thử',
    problem: 'Một đầu ra tốt có thể đến từ việc bạn âm thầm cứu quy trình bằng kinh nghiệm. Một đầu ra xấu cũng chưa chắc do AI yếu. Nếu không lưu đầu ra từng bước và chỗ bạn can thiệp, bạn không biết phải sửa bối cảnh, hướng dẫn, bàn giao, vai trò hay hợp đồng đầu ra.',
    theory: [
      { title: 'Quy trình là giả thuyết cho tới khi chạy', body: 'Bản đồ và hướng dẫn chỉ mô tả điều bạn tin sẽ xảy ra. Một lần chạy từ đầu tới cuối tạo dữ liệu đầu tiên về nơi quy trình thực sự dừng hoặc lệch.' },
      ...
      { title: 'Sửa ít, chạy lại đúng chỗ', body: 'Chọn một hoặc hai lỗi lớn nhất, thay đổi quy trình rồi chạy lại bước bị ảnh hưởng. Nếu sửa mọi thứ cùng lúc, bạn không biết thay đổi nào tạo ra khác biệt.' },
    ],
    misconceptions: [
      { myth: 'Một đầu ra tốt chứng minh quy trình tốt.', correction: 'Có thể người chạy đã dùng hiểu biết ngầm để cứu nó.' },
    ...
    practice: ['Chọn một đầu vào thật bạn có quyền sử dụng.', 'Chạy quy trình từ đầu tới cuối và lưu đầu ra của từng bước.', 'Ghi vấn đề cùng mọi lần con người can thiệp.', 'Đánh giá đầu ra cuối theo Hợp đồng đầu ra.', 'Phân loại lỗi, sửa lỗi lớn nhất và chạy lại bước bị ảnh hưởng.'],
    qualityGate: ['Quy trình đã được chạy trọn vẹn ít nhất một lần.', 'Có đầu ra thật và nhật ký từng bước.', 'Có ít nhất một lỗi hoặc can thiệp được ghi.', 'Có một thay đổi cụ thể trong quy trình.', 'Kết quả chạy lại được ghi để so sánh.'],
    revision: 'Viết lại thay đổi theo dạng “Ở bước nào, thay điều gì, vì lỗi nào” thay vì ghi “cải thiện câu lệnh”.',
    aiLab: { duration: '20–30 phút tùy chọn', role: 'AI đóng vai người điều phối buổi nhìn lại.', prompt: 'Dựa trên nhật ký chạy thử, hãy hỏi tôi lần lượt: điều gì đã xảy ra, điều gì lẽ ra phải xảy ra, khoảng cách xuất hiện ở bước nào và nguyên nhân có thể thuộc nhóm nào. Giúp tôi so sánh trước và sau khi sửa, nhưng không tự tuyên bố quy trình thành công và không đề nghị sửa quá hai vấn đề trong vòng này.' },
  ...
  },
  {
    ...
    title: 'Đóng gói quy trình thành tài sản có thể dùng lại',
    question: 'Người khác có thể chạy lại và chuyển phương pháp này không?',
    concept: 'Bộ quy trình và Bản thiết kế chuyển giao (Transfer Blueprint)', artifact: 'Bộ quy trình hoàn chỉnh',
    problem: 'Một thư mục chứa nhiều câu lệnh chưa phải tài sản. Nếu lần sau bạn không biết chuẩn bị gì, chạy theo thứ tự nào, xử lý lỗi ra sao hoặc khi nào phải cập nhật, quy trình vẫn phụ thuộc trí nhớ của người tạo. Đóng gói biến lần thử thành một hệ thống có phiên bản và có thể chuyển giao.',
    theory: [
      ...
      { title: 'Chuyển giao phương pháp, không sao chép nội dung', body: 'Để chứng minh đã hiểu, bạn phác thảo một quy trình khác bằng cùng câu hỏi thiết kế: kết quả, bối cảnh, hợp đồng, bước, quyết định và kế hoạch thử.' },
    ...
    misconceptions: [
      ...
      { myth: 'Chuyển giao là sao chép mọi câu lệnh nội dung.', correction: 'Bạn phải dùng phương pháp để thiết kế một quy trình cho kết quả khác.' },
      { myth: 'Phải tự động hóa trước khi bàn giao.', correction: 'Tự động hóa một quy trình chưa ổn định chỉ làm lỗi chạy nhanh hơn.' },
    ],
    conanCase: caseFor('Đóng gói tài sản học tập thành một hệ thống có thể cải tiến', 'Conan School đóng gói mục đích, chuẩn bị, bối cảnh, hợp đồng, bước, vai trò, cổng, lỗi và phiên bản của tình huống học tập. Sản phẩm này có thể trở thành một phần Builder Portfolio mà không cần tuyên bố kết quả kinh doanh chưa kiểm chứng.', 'Dùng phương pháp để phác thảo quy trình xử lý biên bản họp, không sao chép nguyên các bước viết bài học.'),
    practice: ['Áp dụng thay đổi từ lần chạy thử và đặt số phiên bản.', 'Viết mục đích, phần chuẩn bị và hướng dẫn chạy một trang.', 'Ghi lỗi phổ biến cùng điều kiện cần cập nhật quy trình.', 'Tải Bộ quy trình thành tệp Markdown để giữ ngoài trình duyệt.', 'Phác thảo một quy trình khác bằng Bản thiết kế chuyển giao.'],
    qualityGate: ['Người khác biết cần chuẩn bị gì và bắt đầu ở đâu.', 'Quyết định con người và kiểm tra đầu ra được nhìn thấy.', 'Có lỗi phổ biến và điều kiện cập nhật.', 'Quy trình thứ hai dùng phương pháp thay vì sao chép luồng nội dung.', 'Toàn bộ bảy sản phẩm có thể xuất thành một tệp.'],
    ...
    aiLab: { duration: '20–30 phút tùy chọn', role: 'AI đóng vai người nhận bàn giao.', prompt: 'Hãy đóng vai một người chưa biết quy trình này. Chỉ dùng Bộ quy trình tôi cung cấp để hỏi cách chuẩn bị, bắt đầu, xử lý điểm quyết định, kiểm tra đầu ra và phục hồi khi lỗi. Sau đó kiểm tra Bản thiết kế chuyển giao bằng câu hỏi; không tự xây quy trình thứ hai thay tôi và không coi câu trả lời mơ hồ là đã đạt.' },
    minimum: 'Một Bộ quy trình có phiên bản và hướng dẫn chạy, cùng một Bản thiết kế chuyển giao cho công việc khác.',
    insideConan: 'Nếu bạn là người xây lần đầu, Conan School và cộng đồng Tokyo giúp tiếp tục hành trình xây sản phẩm thật. Nếu bạn đã có doanh nghiệp và quy trình thật vẫn phụ thuộc người sáng lập, bạn có thể tìm hiểu Conan Maker. Bạn cũng có thể tự chạy quy trình thêm hai lần trong 14 ngày.',
  },
] as const
