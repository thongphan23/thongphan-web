...
const variants = [
  {
    ...
    src: '/review/remotion-muc-dich-doi-song/media/soul-single-film-v2-web.mp4',
    poster: '/review/remotion-muc-dich-doi-song/media/soul-single-film-v2-poster.jpg',
    ...
    evidenceHref: '/review/remotion-muc-dich-doi-song/media/evidence/soul-visual-selection-review.md',
    scorecardHref: '/review/remotion-muc-dich-doi-song/media/evidence/soul-visual-proposition-graph.json',
    continuityHref: '/review/remotion-muc-dich-doi-song/media/evidence/soul-single-film-continuity-report.json',
  },
  {
    id: 'click',
    tab: '02 · Click',
    title: 'Công việc, gia đình và cái giá mất kiểm soát',
    src: '/review/remotion-muc-dich-doi-song/media/click-single-film-v2-web.mp4',
    poster: '/review/remotion-muc-dich-doi-song/media/click-single-film-v2-poster.jpg',
    ...
    scorecardHref: '/review/remotion-muc-dich-doi-song/media/evidence/click-visual-proposition-graph.json',
    continuityHref: '/review/remotion-muc-dich-doi-song/media/evidence/click-single-film-continuity-report.json',
  },
  {
    id: 'forrest-gump',
    tab: '03 · Forrest Gump',
    title: 'Một đời người trong cùng một tuyến phim',
    src: '/review/remotion-muc-dich-doi-song/media/forrest-gump-single-film-v2-web.mp4',
    poster: '/review/remotion-muc-dich-doi-song/media/forrest-gump-single-film-v2-poster.jpg',
    ...
    evidenceHref: '/review/remotion-muc-dich-doi-song/media/evidence/forrest-gump-visual-selection-review.md',
    scorecardHref: '/review/remotion-muc-dich-doi-song/media/evidence/forrest-gump-visual-proposition-graph.json',
    continuityHref: '/review/remotion-muc-dich-doi-song/media/evidence/forrest-gump-single-film-continuity-report.json',
  },
] as const
