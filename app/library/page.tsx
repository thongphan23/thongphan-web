...
export const metadata: Metadata = {
  title: 'Living Library Thông Phan — Public Knowledge Graph',
  description:
    'Thư viện sống của Thông Phan về AI, Brain2, content kéo khách, tài sản số và hệ thống cho người có chuyên môn.',
  alternates: {
    canonical: '/library',
  },
  openGraph: {
    ...
    description:
      'Public knowledge graph cho người có chuyên môn muốn biến kiến thức thật thành tài sản số và hệ thống AI.',
    url: '/library',
    type: 'website',
  },
}
      ...
      <div className="container">
        <header className={styles.hero} data-reveal>
          <div className={styles.heroShell}>
            <div className={styles.heroCopy}>
              <span className={styles.eyebrow}>Living library · Brain2 public layer</span>
              <h1>Thư viện sống cho người có chuyên môn giữa thời AI quá ồn.</h1>
              <p>
                Đây không phải blog công cụ AI. Đây là public knowledge graph của Thông Phan:
                concept, nguyên liệu, mẫu, cấu trúc, template, bản đồ đọc và proof để anh em đi
                từ hoang mang tới sáng tỏ, rồi tạo tài sản số có gốc.
              </p>
              <div className={styles.heroStats} aria-label="Thống kê thư viện">
                <span>{notes.length} note sống</span>
        ...
        <section className={styles.startMaps} aria-labelledby="start-maps-title" data-reveal>
          <div className={styles.sectionHeader}>
            ...
            <h2 id="start-maps-title">Đừng tự mò trong graph. Đi theo một đường đọc trước.</h2>
          </div>
        ...
        <section className={styles.recentSection} aria-labelledby="recent-title" data-reveal>
          <div className={styles.sectionHeader}>
            ...
            <h2 id="recent-title">Những mảnh đang được dùng gần nhất.</h2>
          </div>
