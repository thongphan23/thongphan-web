...
function mockStreamingResponse(message: string) {
  ...
  const mockResponses: Record<string, string> = {
    'brain2': 'Brain2 là hệ thống quản lý tri thức cá nhân của tui — dùng Obsidian vault + atomic notes. Mỗi note là một ý tưởng độc lập, liên kết với nhau tạo thành mạng lưới kiến thức. Há há, nghe fancy nhưng thực ra chỉ là cách tui ghi chép có hệ thống thôi.',
    ...
    'conan': 'Conan School là nơi tui và anh Đắc xây dựng để dạy người đi làm dùng AI đúng cách. Không phải học tool, mà học cách NGHĨ trước khi dùng AI. Workshop Deep AI Content của tui → 600+ comments đăng ký trong 24h đầu.',
    'default': 'Tui là Thông Phan — content marketer 10 năm, Co-Founder Conan School. Tui giúp anh em giữ và +1 thu nhập nhờ dùng AI đúng cách. Hỏi tui về AI, content, Brain2, hay sự nghiệp nhé!'
  }
