...
export const metadata: Metadata = {
  ...
  description: 'Hai mươi mốt bản dựng dọc qua bảy vòng cải tiến, kèm bằng chứng nguồn, carrier, phụ đề, pixel và tự đánh giá.',
  ...
  return (
    <div className={styles.page}>
      <header className={styles.intro}>
        <p className={styles.eyebrow}>TPR · OWNER REVIEW · SOCIAL-SAFE VERTICAL CAPTIONS</p>
        <h1>Hai mươi mốt bản dựng dọc. Bảy vòng cải tiến có bằng chứng.</h1>
        <p className={styles.lede}>
          ...
          Vòng 7 giữ nguyên hình ảnh nhưng khóa phụ đề một dòng gần tầm mắt vào giao điểm
          vùng an toàn TikTok, Reels và Shorts.
        </p>
        <dl className={styles.runFacts}>
          <div><dt>Định dạng</dt><dd>9:16 · 1080×1920</dd></div>
          <div><dt>Thử nghiệm</dt><dd>7 vòng × 3 phim</dd></div>
          <div><dt>Quy tắc vòng 7</dt><dd>Một dòng · vùng an toàn chung</dd></div>
          <div><dt>Vòng cuối</dt><dd>270/270 kiểm tra nền tảng PASS</dd></div>
      ...
      <section className={styles.reviewQuestions} aria-labelledby="questions-title">
        ...
        <ol>
          <li>Vòng 7 có đặt phụ đề tự nhiên ở gần tầm mắt và hơi chếch xuống dưới không?</li>
          ...
          <li>Phụ đề một dòng có tránh tên kênh, mô tả, nút tương tác và vẫn đọc thoải mái không?</li>
          <li>Trong ba bản vòng 7, phim nào có phụ đề hòa với hình ảnh tự nhiên nhất?</li>
        </ol>
        <div className={styles.packageLinks}>
          ...
          <a href="/review/remotion-muc-dich-doi-song/media/evidence/vertical-framing-v1/round-7/OWNER-REVIEW-PACKET.md?v=social-safe-vertical-captions-r7-20260802" target="_blank" rel="noreferrer">
            Gói review vòng 7
          </a>
