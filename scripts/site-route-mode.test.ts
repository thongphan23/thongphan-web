...
test('the unified shell is the safe default while explicit legacy and standalone routes stay isolated', () => {
  const enabled = ['/', '/about', '/diagnostic', '/learn', '/learn/diagnostic', '/assets', '/assets/offer-map', '/experiences', '/experiences/brain2', '/brain2/21-ngay', '/brain2/21-ngay/ngay-01', '/chat', '/library', '/library/read', '/library/read/deep-work', '/library/a-living-note', '/blog', '/blog/a-field-note', '/about/team', '/diagnostic/results', '/chat/thread', '/unknown']
