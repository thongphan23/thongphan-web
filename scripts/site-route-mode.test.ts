...
const routeModeCases: Array<[pathname: string, expected: SiteRouteMode]> = [
  ...
  ['/challenge/content-workflow-7days', 'evidence-dossier'],
  ['/challenge/content-workflow-7days/day-04', 'evidence-dossier'],
...
test('the unified shell is the safe default while explicit legacy and standalone routes stay isolated', () => {
  const enabled = ['/', '/about', '/diagnostic', '/learn', '/learn/diagnostic', '/assets', '/assets/offer-map', '/experiences', '/experiences/brain2', '/challenge/content-workflow-7days', '/challenge/content-workflow-7days/day-04', '/brain2/21-ngay', '/brain2/21-ngay/ngay-01', '/chat', '/library', '/library/read', '/library/read/deep-work', '/library/a-living-note', '/blog', '/blog/a-field-note', '/about/team', '/diagnostic/results', '/chat/thread', '/unknown']
